...
export default function RandomMatch(){
  ...
  return<div className="page-container">
    ...
    {phase==="matching"&&<div><div className="card"><MatchAnimation teamSize={sz} current={match.current} countdown={cd}/></div><button onClick={cancel} className="w-full mt-3 py-2.5 rounded-xl bg-white/[0.02] border border-white/[0.05] hover:bg-white/[0.04] transition text-[10px] text-white/20">Cancel</button></div>}
