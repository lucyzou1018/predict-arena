...
export function MatchAnimation({teamSize,current,countdown,status="matching"}){
  ...
  return<div className="text-center py-4">
    <div className="relative w-28 h-28 mx-auto mb-4"><div className="absolute inset-0 rounded-full border border-violet-500/15"/><div className="absolute inset-0 rounded-full" style={{background:"conic-gradient(from 0deg,transparent,rgba(124,92,255,0.32) 90deg,transparent 180deg)",animation:"radar 1.5s linear infinite"}}/><div className="absolute inset-0 flex items-center justify-center text-4xl">⚔️</div></div>
