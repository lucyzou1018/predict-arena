export function BtcTicker({price,size="lg",label}){
  ...
  return<div className="flex flex-col items-center">
    ...
    <div className="flex items-center gap-2">
      <div className="w-8 h-8 rounded-full bg-gradient-to-br from-amber-400 to-orange-600 flex items-center justify-center text-sm font-black shadow-lg shadow-orange-500/20">₿</div>
      {loading
